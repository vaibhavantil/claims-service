...
public class InternalController {
    ...
    mockMvc
      .perform(post("/i/claims/12345/addAutomaticPayment")
        ...
        .content(objectMapper.writeValueAsString(
          makePaymentDto(UUID.randomUUID().toString(), false, null))))
  ...
  public void Should_ReturnSuccess_WhenMemberSeemsLikeTerroristButWeWantToBypassMeerkat()
    ...
    String CLAIM_ID = "733c5cbe-f7d5-11e8-a18f-4b0bf766f99d";

    this.commandGateway.sendAndWait(
      new CreateClaimCommand(CLAIM_ID, MEMBER_ID, LocalDateTime.now(), "TEST"));
    ...
    given(claimsRepository.findById(Mockito.anyString()))
      .willReturn(Optional.of(makeClaimEntity(CLAIM_ID)));

    mockMvc
      .perform(post("/i/claims/12345/addAutomaticPayment")
        .contentType(MediaType.APPLICATION_JSON)
        .content(objectMapper.writeValueAsString(
          makePaymentDto(CLAIM_ID, true, null))))
  ...
  public void Should_ReturnForbidden_WhenWeWantToBypassWithoutReason()
    ...
    String CLAIM_ID = "f5145de8-f7d7-11e8-a3a7-0bfc9d610820";
    ...
    mockMvc
      .perform(post("/i/claims/12345/addAutomaticPayment")
        .contentType(MediaType.APPLICATION_JSON)
        .content(objectMapper.writeValueAsString(
          makePaymentDto(CLAIM_ID, true, " "))))
      .andExpect(status().isForbidden());
  }

  private PaymentDTO makePaymentDto(String id, boolean bypass, String reason) {
    return new PaymentDTO("12345", id,
      LocalDateTime.now(),
      "12345",
      123.01,
      "note",
