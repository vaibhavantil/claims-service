...
public class UpdateClaimTypeCommand {
  ...
  @TargetAggregateIdentifier private String claimsId;
  private String userId;
  private LocalDateTime registrationDate;
  private String type;

  public UpdateClaimTypeCommand(
      String claimsId, String userId, LocalDateTime registrationDate, String type) {
    log.info(
